...
parser.add_argument('--dataset', type=str, choices=['something', 'jester', 'nvgesture', 'chalearn', 'kussaster'], default='jester')
...
parser.add_argument('--root_test_input', type=str, default='input')
parser.add_argument('--root_weights', type=str, default='/home/machine/PROJECTS/OTHER/fubel/stmodeling/model/STModeling_jester_RGB_BNInception_TRNmultiscale_segment8_checkpoint.pth.tar')
parser.add_argument('--run_for', type=str, default='test', help='train or test')
